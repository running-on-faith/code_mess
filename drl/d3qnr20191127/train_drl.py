...
def train_round_iter_func(round_n_per_target_day=2, target_avg_holding_days=[5, 7, 9]):
    """
    迭代器函数：每轮训练迭代参数 迭代器
...
def _test_train_on_each_period():
    ...
    train_on_each_period(
        ...
        train_round_kwargs_iter_func=functools.partial(train_round_iter_func, round_n_per_target_day=3), n_step=60,
