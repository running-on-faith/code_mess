...
def valid_whole_episodes_and_summary_report(read_csv=True, auto_open_file=False, auto_open_summary_file=False,
    ...
    if is_windows_os():
        output_folder = r'D:\WSPych\code_mess\drl\drl_off_example\d3qnr20191127\output'
    else:
        output_folder = r'/home/mg/github/code_mess/drl/d3qnr20191127/output'
...
if __name__ == "__main__":
    ...
    # )
    valid_models_and_summary_report(
        output_folder='/home/mg/github/code_mess/drl/d3qnr20191127/output2020-02-01',
